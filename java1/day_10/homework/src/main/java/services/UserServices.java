...
public class UserServices {
    ...
    public void register() throws IOException {
        ...
        if (!Pattern.matches(email_pattern,email)){
            throw new nam("Email khong dung dinh dang");
        }
        int count=0;
        for (User u:listUser) {
        ...
        if (count>0){
            throw new nam("Email da ton tai");
        }
    ...
    public User login(){
        ...
        if (count == 0){
            throw new nam("Email hoac Mat khau khong chinh xac");
        }
        return user;
    }
    public void forgetPassword(){
        ...
        if (count == 0){
            throw new nam("Email khong ton tai");
        }
        else {
    ...
    public void changeEmail(User user){
        ...
        if (count>0){
            throw new nam("Trung email roi bro");
        }
